...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="absolute top-0 left-0 right-0 z-20 pointer-events-none">
      ...
      <div className="flex items-center justify-between gap-4 mx-5 mt-5 pointer-events-auto">
        {/* 1. Studio Brand Minimal Signature */}
        <div className="flex items-center gap-2.5 bg-slate-900/80 backdrop-blur-xl border border-white/[0.08] px-3.5 py-2 rounded-xl shadow-2xl shadow-black/40 shrink-0">
        ...
        {/* 2. Command Bar — desktop only (≥ sm) */}
        <div className="flex-1 max-w-md hidden sm:block">
          {inputBar}
        </div>

        {/* 3. Theme Swatches + Actions */}
      ...
      {/* Mobile-only full-width URL input bar (< sm breakpoint) */}
      <div className="sm:hidden mx-3 mt-2 pointer-events-auto">
        {inputBar}
      </div>
    </header>
  );
